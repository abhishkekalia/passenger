...
export const blueTheme = new MappingKit.Theme({
  icon: blueUnselectedHouse,
  activeIcon: blueSelectedHouse,
...
export const greenTheme = new MappingKit.Theme({
...
export const grayTheme = new MappingKit.Theme({
...
export const neutralTheme = new MappingKit.Theme({
